  ...
  return (
    <div className="min-h-screen bg-background text-foreground antialiased">
      ...
      <section ref={parallaxRef} className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col items-start justify-end px-5 pb-16 pt-[42vh] sm:justify-center sm:px-6 sm:pb-24 sm:pt-24">
          <div data-reveal>
